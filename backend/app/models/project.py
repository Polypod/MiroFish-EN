...
Persists project state on the server to avoid passing large payloads between frontend API calls.
"""
...
class Project:
    ...
    # Ontology information (filled after API 1)
...
class ProjectManager:
    """Project manager - handles persistent storage and retrieval for projects."""
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get extracted text storage path for the project."""
