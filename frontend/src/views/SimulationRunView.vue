...
// Direct access maxRounds from query parameters during initialization to ensure child component gets value immediately
...
onMounted(() => {
  ...
  // Log maxRounds configuration (value already obtained from query parameter during initialization)
  if (maxRounds.value) {
